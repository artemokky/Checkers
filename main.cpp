...
void Menu() {
	...
	std::cout << "RANDOM BOT - PRESS 2" << std::endl;
	std::cout << "KIND BOT - PRESS 3" << std::endl;
	std::cout << "ME - PRESS 4" << std::endl;

	while ((play_or_watch == 1 || play_or_watch == 2 || play_or_watch == 3 || play_or_watch == 4) != true) {
		std::cin >> play_or_watch;
	}
	if (play_or_watch == 1) {
		player1 = new BotV1(&playboard);
	}
	else if (play_or_watch == 2) {
		player1 = new BotV2(&playboard);
	}
	else if (play_or_watch == 3) {
		player1 = new BotV3(2, &playboard);
	}
	...
	if (play_or_watch == 1) {
		player2 = new BotV1(&playboard);
	}
	else if (play_or_watch == 2) {
		player2 = new BotV2(&playboard);
	}
	else if (play_or_watch == 3) {
		player2 = new BotV3(3, &playboard);
	}
	else if (play_or_watch == 4) {
